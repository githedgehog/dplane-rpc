...
#define DEF_INSERT(name, type)                               \
    int insert_##name(buff_t *buff, index_t pos, type data)  \
    {                                                        \
        BUG(!buff, E_BUG);                                   \
...
#define DEF_PUT(name, type)                         \
    int put_##name(buff_t *buff, type data)         \
    {                                               \
...
#define DEF_GET(name, type)                          \
    int get_##name(buff_t *buff, type *out)          \
    {                                                \
...
/* decl */
#define DECL_PUT(name, type) int put_##name(buff_t *buff, type data)
#define DECL_GET(name, type) int get_##name(buff_t *buff, type *out)
#define DECL_INSERT(name, type) int insert_##name(buff_t *buff, index_t pos, type data)
